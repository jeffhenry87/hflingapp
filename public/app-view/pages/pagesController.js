app.controller('PagesController', ['$rootScope','$scope','$location' ,'HttpService','$window','FlashService', '$modal', 'MetaService', function( $rootScope,$scope,$location,HttpService,$window,FlashService, $modal, MetaService ){
    var vm = this;
