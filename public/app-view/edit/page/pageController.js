app.controller('PageController', ['$rootScope','$scope','$location' ,'HttpService','$window','FlashService', '$modal', '$routeParams', 'MetaService', function( $rootScope,$scope,$location,HttpService,$window,FlashService, $modal, $routeParams, MetaService ){
    var vm = this;
